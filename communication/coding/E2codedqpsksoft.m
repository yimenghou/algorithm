...
% Simulation Chain
% ======================================================================= %
BERcodedE2soft = zeros (1, length(EbN0)); % pre - allocate a vector for the BER results
cmpbits=[0 0 1 1 0 1 1 0];
CodeGenerator=[str2num(dec2base(bin2dec('10111'),8)) ...
str2num(dec2base(bin2dec('10110'),8))];
ConstraintLength=5;
   ...
   totErr = 0; % running number of errors observed
    ...
    while (( totErr < maxNumErrs ) && ( num < maxNum ))
        ...
        for i=1:1:N+4
            ...
            prevdist(3)=currdist(2)+dh10;
            prevdist(4)=currdist(2)+dh01;            
            prevdist(5)=currdist(3)+dh11;
            prevdist(6)=currdist(3)+dh00;            
            prevdist(7)=currdist(4)+dh01;
            prevdist(8)=currdist(4)+dh10;            
            prevdist(9)=currdist(5)+dh11;
            prevdist(10)=currdist(5)+dh00;            
            prevdist(11)=currdist(6)+dh01;
            prevdist(12)=currdist(6)+dh10;            
            prevdist(13)=currdist(7)+dh00;
            prevdist(14)=currdist(7)+dh11;            
            prevdist(15)=currdist(8)+dh10;
            prevdist(16)=currdist(8)+dh01;
            prevdist(17)=currdist(9)+dh00;
            prevdist(18)=currdist(9)+dh11;            
            prevdist(19)=currdist(10)+dh10;
            prevdist(20)=currdist(10)+dh01;            
            prevdist(21)=currdist(11)+dh11;
            prevdist(22)=currdist(11)+dh00;            
            prevdist(23)=currdist(12)+dh01;
            prevdist(24)=currdist(12)+dh10; 
            prevdist(25)=currdist(13)+dh11;
            prevdist(26)=currdist(13)+dh00;            
            prevdist(27)=currdist(14)+dh01;
            prevdist(28)=currdist(14)+dh10;            
            prevdist(29)=currdist(15)+dh00;
            prevdist(30)=currdist(15)+dh11;            
            prevdist(31)=currdist(16)+dh10;
            prevdist(32)=currdist(16)+dh01;
    ...
    BERcodedE2soft(m) = totErr/num;
end
parfor_progress(0);
disp(['Time: ',num2str(toc/60),'min'])
semilogy(EbN0,BERcodedE2soft,'r-x')
grid on
ylim([1e-5 1])
xlim([-1 10])
ylabel('BER')
...
legend()
hold on
clearvars -except BERcodedE2soft
save('BERForPlotsE2soft')
